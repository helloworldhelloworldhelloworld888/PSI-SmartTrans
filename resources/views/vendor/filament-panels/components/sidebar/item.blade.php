...
>
    <a
        ...
        @endif
        @class([
            'fi-sidebar-item-button relative flex items-center justify-center gap-x-3 rounded-lg px-2 py-2 outline-none transition duration-75 hover:bg-primary-600 focus-visible:bg-primary-600 dark:hover:bg-white/5 dark:focus-visible:bg-white/5',
            'bg-primary-600 dark:bg-white/5' => $active,
        ])
    >
