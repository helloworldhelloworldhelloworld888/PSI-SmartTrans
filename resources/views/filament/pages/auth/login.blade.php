<div class="flex min-h-full flex-col bg-white flex-1">
    <div class="flex min-h-full flex-1">
        <div class="flex flex-1 flex-col justify-center px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96 bg-slate-100 shadow-md py-5">
                <div style="background-color: #003273; border-radius: 10px 10px 0 0;">
                    <div class="p-7 py-10">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="mt-6 grid grid-cols-3 gap-4 px-14">
                            <a href="#"
                                ...
                                <svg class="h-5 w-5" viewBox="0 0 25 24" fill="currentColor"
                            ...
                            <a href="#"
                                ...
                                <svg class=" h-5 w-5" fill="currentColor" viewBox="0 0 25 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
        ...
        <div class="relative hidden w-0 flex-1 lg:block">
            <img class="absolute inset-0 h-full w-full object-cover" src="{{ asset('images/bg.png') }}" alt="">
        </div>
    </div>
</div>
