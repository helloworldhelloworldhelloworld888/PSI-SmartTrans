    ...
    <div class="p-7">
        <x-filament-panels::form wire:submit="register">
            <div>
                ...
                <p class="mt-2 text-sm leading-6 text-gray-500">
                    Mari kita siapkan semuanya agar Anda dapat mengakses akun pribadi Anda.
                </p>
            </div>
        ...
        <div class="mt-10">
            ...
            <div class="text-center mt-2">
                <a href="{{ filament()->getLoginUrl() }}" class="text-sm font-medium">
                    sudah punya akun? <span style="color: #FF8682">Masuk</span>
                </a>
            </div>
        </div>
    </div>
